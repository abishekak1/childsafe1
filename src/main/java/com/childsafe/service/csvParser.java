...
public class csvParser {
    ...
    public void createCouncilList() throws Exception{
        ...
        BufferedReader br = new BufferedReader(new FileReader("E:/childsafe/src/main/webapp/WEB-INF/resources/data/council1.csv"));
        String line = null;
    ...
    public void createSuburblList() throws Exception{
        ...
        BufferedReader br = new BufferedReader(new FileReader("E:/childsafe/src/main/webapp/WEB-INF/resources/data/suburb3.csv"));
        String line = null;
