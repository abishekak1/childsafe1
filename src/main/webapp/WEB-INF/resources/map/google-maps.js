                    ...
                    $timeout(function () {
                        ...
                        angular.forEach(newValue, function (v, i) {
                            if (!_m.hasMarker(v.latitude, v.longitude)) {
                                ...
                                if(v.category == 'coffee'){
                                    _m.addMarker(v.latitude, v.longitude, 'http://maps.google.com/mapfiles/kml/pal2/icon4.png', v.name);
                                }else{
                                    _m.addMarker(v.latitude, v.longitude, 'http://maps.google.com/mapfiles/kml/pal2/icon55.png', v.name);
                                }
